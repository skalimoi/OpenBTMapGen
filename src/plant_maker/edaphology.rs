...
use crate::plant_maker::config::{GreyscaleImage, Map};

const STANDARD_NORMAL: Vector3<f64> = Vector3::new(0.0, 0.0, 1.0);

/// It calculates the plant_maker depth at every point of the terrain. It uses the previously calculated angles (steepness).
/// :param map: Object of Map class. Used to get the max plant_maker depth.
